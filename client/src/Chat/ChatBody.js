    ...
    <div>
      ...
      {messages.map((message) => (
        <div
          key={message.id}
          className={`
                    ${message.uid === user.uid ? "chat__message chat__sender" : "chat__message chat__reciever"} 
                    ${message.photo && "chat__message chat__message_media_image"}
                    ${message.video && "chat__message chat__message_media_video"}
                    ${message.notification && "chat__message_reminder chat__createdBy specialClass"}
                    ${
                      message.video &&
                      !message.caption &&
                      "chat__message chat__message_media_video_noCaption"
                    } `}
        >
